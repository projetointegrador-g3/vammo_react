...
const Sidebar = () => {
  ...
  if (location.pathname==="/home" || location.pathname==="/perfil" || location.pathname==="/editarperfil/1" || location.pathname==="/configuracao" || location.pathname==="/veiculo" || location.pathname==="/viagens")
  return (
    <aside className="flex flex-col fixed w-20 items-center top-0 pl-4 bg-[#212121] gap-10">

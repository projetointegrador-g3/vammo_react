      ...
      <main className='flex flex-col items-start p-6'>
        ...
        <div className='mt-6 space-y-4'>
          ...
          <div className='space-y-3'>
            ...
            <input
              ...
              className='w-full p-3 border rounded-xl'
            />
            <button className='w-full py-3 bg-[#D8F505] rounded-xl flex justify-between px-4'>
              <span>Pesquisar</span>
              <ArrowRight />
            </button>
          </div>
        ...
        <div className='mt-6'>
          ...
          <div className='flex items-center justify-between'>
            <div>
              <p>
              <strong>Gastos do mês:</strong> R$424,90</p>
              <p>
              <strong>Distância Percorrida:</strong> 89.5km</p>
            </div>
